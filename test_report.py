...
class ReportContractTest(unittest.TestCase):
    ...
    def test_public_html_has_no_internal_markers(self) -> None:
        ...
        self.assertIn(".video-column .workflow-strip", html)
        self.assertIn(".video-column .hero", html)
        self.assertIn(".video-column .toolbar", html)
        self.assertIn("videoColumn.append(videoSlot,workflow,hero)", html)
        self.assertIn("if(toolbar)videoColumn.append(toolbar)", html)
        self.assertIn("if(cards)resultsColumn.append(cards)", html)
        self.assertNotIn("main.insertBefore(workflow", html)
