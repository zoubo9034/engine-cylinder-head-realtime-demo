...
let liveReceiverPeer = null, liveSenderPeer = null, liveSourceVideo = null, liveRemoteStream = null;
...
function closeLocalSender(){if(liveSenderPeer){liveSenderPeer.close();liveSenderPeer=null}if(liveSourceVideo){liveSourceVideo.pause();liveSourceVideo.src="";liveSourceVideo.remove();liveSourceVideo=null}}
